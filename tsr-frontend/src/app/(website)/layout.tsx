...
export default function WebsiteLayout({
  ...
  return (
    <div className="relative min-h-screen bg-[#05050f] overflow-x-hidden">
      {/* Global deep blue radial background */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[700px] rounded-full bg-[#1a1a6e]/60 blur-[120px]" />
